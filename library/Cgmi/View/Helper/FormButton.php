 ...
 */
class Cgmi_View_Helper_FormButton extends Zend_View_Helper_FormElement
{
    /**
    ...
    public function formButton($name, $value = null, $attribs = null)
    {
        ...
        $btIcon = '';
        if ( isset($attribs['btIcon']) ){
            $btIcon = "<span class=\"{$attribs['btIcon']}\" aria-hidden=\"true\"></span> ";
            unset($attribs['btIcon']);
        }
