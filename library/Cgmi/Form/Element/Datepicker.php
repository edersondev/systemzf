...
class Cgmi_Form_Element_Datepicker extends Cgmi_Form_Element {
	...
	$this->getView ()->headLink ()->appendStylesheet ( $view->baseUrl () . '/components/datepicker/css/datepicker3.css' );
