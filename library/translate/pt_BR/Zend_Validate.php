...
return array(
    ...
    "Invalid type given, value should be a string" => "Tipo especificado inválido, o valor deve ser uma string",
    "'%value%' is not a valid email address in the basic format local-part@hostname" => "'%value%' não é um endereço de e-mail válido",
    ...
    "The two given tokens do not match" => "Os dois campos de dados não corresponderem",
